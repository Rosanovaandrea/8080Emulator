    ...
    public void emulationProcess(){
        ...
        switch (opcode) {
            ...
            case 0x88:
                previousCy = cy;
                mask = cy ? -1 : 0;
                tempAc = (~a & 0x0f) <= (b & 0x0f);
                ac = (~a & 0x0f) < (b & 0x0f);
                tempCy = (~a & 0xff) <= (b & 0xff);
                cy = (~a & 0xff) < (b & 0xff);
                temp = a + b + 1;
                temp2 = a + b;
                ac = previousCy ? tempAc : ac;
                cy = previousCy ? tempCy : cy;
                a = mask & temp | temp2 & ~mask;
                a = a & 0xff;
                z = a == 0;
                p = Integer.bitCount(a) % 2 == 0;
                s = a >>> 7 != 0;
            ...
            case 0x89:
                previousCy = cy;
                mask = cy ? -1 : 0;
                tempAc = (~a & 0x0f) <= (c & 0x0f);
                ac = (~a & 0x0f) < (c & 0x0f);
                tempCy = (~a & 0xff) <= (c & 0xff);
                cy = (~a & 0xff) < (c & 0xff);
                temp = a + c + 1;
                temp2 = a + c;
                ac = previousCy ? tempAc : ac;
            ...
            case 0x8a:
                previousCy = cy;
                mask = cy ? -1 : 0;
                tempAc = (~a & 0x0f) <= (d & 0x0f);
                ac = (~a & 0x0f) < (d & 0x0f);
                tempCy = (~a & 0xff) <= (d & 0xff);
                cy = (~a & 0xff) < (d & 0xff);
                temp = a + d + 1;
                temp2 = a + d;
                ac = previousCy ? tempAc : ac;
            ...
            case 0x8b:
                previousCy = cy;
                mask = cy ? -1 : 0;
                tempAc = (~a & 0x0f) <= (e & 0x0f);
                ac = (~a & 0x0f) < (e & 0x0f);
                tempCy = (~a & 0xff) <= (e & 0xff);
                cy = (~a & 0xff) < (e & 0xff);
                temp = a + e + 1;
                temp2 = a + e;
                ac = previousCy ? tempAc : ac;
            ...
            case 0x8c:
                previousCy = cy;
                mask = cy ? -1 : 0;
                tempAc = (~a & 0x0f) <= (h & 0x0f);
                ac = (~a & 0x0f) < (h & 0x0f);
                tempCy = (~a & 0xff) <= (h & 0xff);
                cy = (~a & 0xff) < (h & 0xff);
                temp = a + h + 1;
                temp2 = a + h;
                ac = previousCy ? tempAc : ac;
